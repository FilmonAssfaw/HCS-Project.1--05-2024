...
const apiURL = `https://api.openweathermap.org/data/2.5/weather?q=Asmara&appid=6e20016a7bcb963f4843326fb4656e16&units=metric`;
...
document.addEventListener("DOMContentLoaded", () => {
  const map = L.map("map").setView([15.339485, 38.9328], 13);
  ...
  const marker = L.marker([15.3389667, 38.9326763]).addTo(map);

  const popupContent = `
      <div class="map__popup">
        <h2 class="map__popup-title">Asmara</h2>
        <p class="map__popup-description">Come visit the red sea its nice here.</p>
      </div>
    `;
